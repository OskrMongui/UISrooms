  ...
  return (
    <div className="space-form">
      <div className="d-flex justify-content-between align-items-start flex-wrap gap-3 mb-4">
        <div>
          <h1 className="mb-1">Crear espacio</h1>
          <p className="text-muted mb-0">Registra un nuevo espacio para que pueda ser reservado.</p>
        </div>
                ...
                <div className="row g-3">
                  ...
                  <div className="col-md-6">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      placeholder="Nombre visible para los usuarios"
                      required
                    />
                  </div>
                  <div className="col-12">
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      placeholder="Indica equipamiento, ubicacion exacta o usos recomendados"
                    />
                  </div>
                </div>
              </div>
                ...
                <div className="row g-3">
                  ...
                  <div className="col-md-6">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      placeholder="proyector, computador, sonido"
                    />
