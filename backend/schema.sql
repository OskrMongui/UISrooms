...
-- 12) Notificaciones (programadas y de reserva)
...
-- 13) Vistas útiles (ejemplos) para endpoints
...
-- 15) Recomendaciones de índices adicionales
CREATE INDEX idx_reservas_usuario ON reservas(usuario_id);
CREATE INDEX idx_reservas_periodo ON reservas(periodo);

-- 16) Permisos (ejemplo mínimo) - adaptar según despliegue y roles OS
